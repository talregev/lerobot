...
from lerobot.envs.configs import AlohaEnv, EnvConfig, LiberoEnv, PushtEnv, GymnasiumEnv
...
def make_env(
    ...
    elif "gymnasium" in cfg.type:
        from lerobot.envs.gymnasium import create_gymnasium_envs

        if cfg.task is None:
            raise ValueError("Gym robotics requires a task to be specified")
        return create_gymnasium_envs(cfg)
